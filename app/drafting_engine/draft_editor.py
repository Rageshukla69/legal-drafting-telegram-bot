...
EDIT_SCHEMA = {
    "type": "object",
    "properties": {
        "operation": {"type":"string", "enum":["replace","delete","insert_before","insert_after"]},
...
class DraftEditor:
    ...
    def apply(self, draft: dict[str, Any], edit: dict[str, Any]) -> tuple[dict[str, Any], str]:
        ...
        if operation not in {"replace","delete","insert_before","insert_after"}: raise ValueError("Unsupported edit operation.")
